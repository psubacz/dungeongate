...
- prompt generation. if you some into an issue is complex, ask cluade to generate a prompt to fix the issue, clear the history, and inject that prompt as the next ste
